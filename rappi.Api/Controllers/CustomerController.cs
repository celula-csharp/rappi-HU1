...
public class CustomersController : ControllerBase
{
    ...
    [HttpPut("{id:int}")] public async Task<IActionResult> Put(int id, Customer c) => await _svc.UpdateAsync(id, c) ? Ok(c) : NotFound();
    [HttpDelete("{id:int}")] public async Task<IActionResult> Delete(int id) => await _svc.DeleteAsync(id) ? NoContent() : NotFound();
}