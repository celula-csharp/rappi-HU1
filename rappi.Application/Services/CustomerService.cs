...
public class CustomerService
{
    ...
    public async Task<Customer> AddAsync(Customer c) { await _db.Customers.AddAsync(c); await _db.SaveChangesAsync(); return c; }
    ...
    public async Task<bool> DeleteAsync(int id) { var e = await _db.Customers.FindAsync(id); if (e==null) return false; _db.Customers.Remove(e); await _db.SaveChangesAsync(); return true; }
}